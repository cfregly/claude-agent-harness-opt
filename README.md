...
fixtures later, reconciles Markdown live-matrix result tables with their raw-matrix summaries,
checks coverage Markdown summaries against sibling JSON receipts, checks matrix-coverage receipts,
model-matrix receipt rows, and aggregate coverage-suite audits against their retained source
